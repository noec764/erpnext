...
def execute():
	...
	if not frappe.db.table_exists("Employee Tax Exemption Declaration") or not frappe.db.has_column(
		"Employee Tax Exemption Declaration", "income_from_other_sources"
	):
		return
