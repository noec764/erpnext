...
from erpnext.hr.doctype.attendance.attendance import DuplicateAttendanceError, mark_attendance
	...
	def process_auto_attendance_based_on_shift_assignments(self):
		...
		for doc in frappe.get_all(
			...
			if doc.shift_type not in shift_type_data:
				shift_type_data[doc.shift_type] = frappe.db.get_value(
					"Shift Type", doc.shift_type, ["start_time", "end_time"]
				)
