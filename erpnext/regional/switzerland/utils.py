...
from erpnext.accounts.page.bank_reconciliation.auto_bank_reconciliation import (
...
def match_esr_reference(doctype, auto_bank_reconciliation):
	esr_reference_docs = []
	for reference in [
		auto_bank_reconciliation.bank_transaction.get("reference_number"),
		auto_bank_reconciliation.bank_transaction.get("description"),
	]:
		if reference:
