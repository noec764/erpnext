...
erpnext.journalAdjustment = class AccountingJournalAdjustment {
	...
	make() {
		...
		this.dialog = new frappe.ui.Dialog({
			...
			primary_action: function() {
				frappe.xcall('erpnext.accounts.doctype.accounting_journal.accounting_journal.accounting_journal_adjustment', {
					doctype: me.doctype,
	...
	get_accounting_entries() {
		frappe.xcall('erpnext.accounts.doctype.accounting_journal.accounting_journal.get_entries', {
