...
def validate_item_attribute_value(attributes_list, attribute, attribute_value, item):
	...
	if allow_rename_attribute_value:
		...
		frappe.throw(_("The value {0} is already assigned to an exisiting Item {1}.").format(
			attribute_value, item), InvalidItemAttributeValueError, title=_('Invalid Attribute'))
