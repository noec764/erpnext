...
web_include_js = ["erpnext-web.bundle.js", "portal-calendar.bundle.js"]
...
doc_events = {
	...
	"Event": {"on_update": "erpnext.venue.doctype.item_booking.item_booking.move_booking_with_event"},
	"Sales Order": {
