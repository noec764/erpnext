...
<img alt="Accounts Frozen Date" class="screenshot" src="../assets/frozen-date-1.png">
...
<img alt="Frozen Date Error" class="screenshot" src="../assets/frozen-date-2.png">
...
<img alt="Frozen Date Error" class="screenshot" src="../assets/frozen-date-3.png">
