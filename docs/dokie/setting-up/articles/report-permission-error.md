...
<img alt="Report Permission Error" class="screenshot" src="../assets/report-permission-1.png">
...
3.  To resolve this issue, I have assigned Account User permission to Read Territory master.  
    ...
    <img alt="Permission Manager" class="screenshot" src="../assets/report-permission-2.png">
