...
<img class="screenshot" alt="Original Delivery Note" src="./assets/sales-return-original-delivery-note.png">
...
<img class="screenshot" alt="Return Against Delivery Note" src="./assets/sales-return-against-delivery-note.png">
...
<img class="screenshot" alt="Return Against Sales Invoice" src="./assets/sales-return-against-sales-invoice.png">
...
<img class="screenshot" alt="Return Stock Ledger" src="./assets/sales-return-stock-ledger.png">
...
<img class="screenshot" alt="Return Stock Ledger" src="./assets/sales-return-general-ledger.png">