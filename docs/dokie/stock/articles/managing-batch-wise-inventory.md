...
<img alt="Batch Item" class="screenshot" src="../assets/batchwise-stock-1.png">

You can create a new Batch from:

`Stock > Documents > Batch > New`

To learn more about batch, click [here.](/dokie/stock/batch.md)
...
<img alt="Batch in Purchase Receipt" class="screenshot" src="../assets/batchwise-stock-2.png">
...
<img alt="Batch in Delivery Note" class="screenshot" src="../assets/batchwise-stock-3.png">
...
<img alt="Batchwise Stock Balance" class="screenshot" src="../assets/batchwise-stock-4.png">
