...
<img class="screenshot" alt="Standard fields in Sales Order" src="../assets/fetching-1.png">

Sales Invoice (custom fields)

<img class="screenshot" alt="Custom Field in Sales Invoice" src="../assets/fetching-2.png">
...
<img class="screenshot" alt="Values fetching from Sales Order to Sales Invoice" src="../assets/fetching-3.gif">
