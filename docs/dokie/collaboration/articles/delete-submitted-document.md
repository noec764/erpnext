...
<img alt="Cancel Doc" class="screenshot" src="../assets/delete-submitted-doc-1.png">

####Step 2: Delete Document

After cancellation, go to Menu and click on Delete.

<img alt="Delete Doc" class="screenshot" src="../assets/delete-submitted-doc-2.png">
...
<img alt="Delete Doc from List" class="screenshot" src="../assets/delete-submitted-doc-3.gif">
