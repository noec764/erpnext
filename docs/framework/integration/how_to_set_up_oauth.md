...
[OAuth 2.0](https://tools.ietf.org/html/rfc6749) provider based on [oauthlib](https://github.com/idan/oauthlib) is built into frappe. Third party apps can now access resources of users based on Frappe Role and User permission system. To setup an app to access
...
![Oauth Settings](./oauth_provider_settings.png)
...
![Oauth client app](./oauth2_client_app.png)
