...
<img class="screenshot" alt="Woocommerce Integration" src="./assets/woocommerce_setting_config.gif">
...
<img class="screenshot" alt="Woocommerce Integration" src="./assets/woocommerce_demo.gif">
