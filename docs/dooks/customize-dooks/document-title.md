...
From Dooks Version 6.0 onwards, all transactions have a `title` property. If there is not a title property, you can add a **Custom Field** as title and set the **Title Field** via **Customize Form**.
...
<img class="screenshot" alt = "Customize Title" src="./assets/customize-title.gif">
...
<img class="screenshot" alt = "Editable Title" src="./assets/editable-title.gif">
