...
<img alt="Sales Order File Attachment" class="screenshot" src="../assets/merge-docs-1.png">
...
<img alt="Sales Order File Attachment" class="screenshot" src="../assets/merge-docs-2.gif">

###Effect of Merging

After Account is merged, new name is updated in the existing transactions where old account was selected.

<div> Note: Group Account cannot be merged into Child Account and vice versa.</div>
