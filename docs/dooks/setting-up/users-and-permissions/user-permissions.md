...
<img src="../assets/users-and-permissions/user-perms/new-user-permission.png" class="screenshot" alt="Creating a new user permission">
...
<img src="../assets/users-and-permissions/user-perms/advanced-control.png" class="screenshot" alt="Creating a new user permission">
...
<img src="../assets/users-and-permissions/user-perms/ignore-user-permissions.png" class="screenshot" alt="Ignore User Permissions on specific properties">
...
<img src="../assets/users-and-permissions/user-perms/permitted-documents.png" class="screenshot" alt="Permitted Documents for User report">
