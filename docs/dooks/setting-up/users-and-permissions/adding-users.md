...
There are two main classes of users: Web Users and System Users. System Users are people using Dokie in the company. Web users are customers or suppliers (or portal users).
...
<img class="screenshot" src="../assets/users/user-1.png" alt="User List">
...
<img class="screenshot" src="../assets/users/add-user-details.png" alt="Add User Details">
...
<img class="screenshot" src="../assets/users/user-login-email.png" alt="Email Login">

<img class="screenshot" src="../assets/users/user-login-mobile.png" alt="Mobile No Login">
...
<img class="screenshot" src="../assets/users/user-2.png" alt="User Roles">
...
<img class="screenshot" src="../assets/users/user-3.png" alt="User Block Module">
...
<img class="screenshot" src="../assets/users/user-4.png" alt="User Security">
