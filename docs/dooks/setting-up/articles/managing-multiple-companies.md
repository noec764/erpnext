...
Dooks allows you to create multiple companies in a single Dooks instance.
...
If you have separate teams working on each company, you can restrict access of the User to the data of specific Company. Click [here](/dooks/setting-up/users-and-permissions/) to know how to set permission rules for giving restricted access to the User.
...
A separate Chart of Account master will be set for each company in the Dooks. This allows you managing Accounts/Ledger master separately for each company. Also it allows you avail financial statement and reports like Balance Sheet and Profit and Loss Statement separately for each company.
