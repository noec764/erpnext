...
<img class="screenshot" alt="POS Setting" src="./assets/pos_profile.png">

To set the default mode of payment, enabled the option default in the mode of payments table
<img class="screenshot" alt="POS Setting" src="./assets/default_mop.png">
...
<img class="screenshot" alt="POS Setting" src="./assets/item_customer_group.png">
