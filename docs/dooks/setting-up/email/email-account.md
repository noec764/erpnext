...
<img class="screenshot" alt="Defining Criteria" src="../assets/email/email-account-list.png">
...
<img class="screenshot" alt="Outgoing EMail" src="../assets/email/email-account-sending.png">
...
<img class="screenshot" alt="Incoming EMail" src="../assets/email/email-account-incoming.png">
