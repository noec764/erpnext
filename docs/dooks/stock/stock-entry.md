...
<img class="screenshot" alt="Stock Entry" src="./assets/stock-entry.png">
...
<img class="screenshot" alt="Stock Entry Additional Costs" src="./assets/additional-costs-table.png">
...
<img class="screenshot" alt="Stock Entry Item Valuation Rate" src="./assets/stock-entry-item-valuation-rate.png">
