...
<img alt="UoM Must be Whole No" class="screenshot" src="../assets/uom-fraction-1.png">
...
<img alt="UoM Validation Message" class="screenshot" src="../assets/uom-fraction-2.png">
