...
<img alt="Purchase Tax and Charges Categories" class="screenshot" src="../assets/purchase-other-charges-1.png">
...
If VAT 4% is applied on item, it will amount to INR 32 (at item's based rate is 800). Since VAT is the consumption tax, it should be added value of Purchase Order/Invoice, since it will be included in payable towards supplier. But its should not be added to the value of Purchased item.
...
Check [here](/dokie/stock/accounting-of-inventory-stock/perpetual-inventory.md) to learn general posting done for expense categorized as Valuation.
