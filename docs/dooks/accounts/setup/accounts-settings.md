...
* Allow Stale Exchange Rate:  This should be unchecked if you want Dokie to check the age of records fetched from Currency Exchange in foreign currency transactions. If it is unchecked, the exchange rate field will be read-only in documents. 
