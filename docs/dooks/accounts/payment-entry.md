...
<img class="screenshot" alt="Making Payment" src="./assets/payment-entry-5.gif">

####Step 6: Submit

Save and Submit Payment Entry. On submission, outstanding will be updated in the Invoices. 

<img class="screenshot" alt="Making Payment" src="./assets/payment-entry-8.png">
...
<img class="screenshot" alt="Making Payment" src="./assets/payment-entry-7.png">
