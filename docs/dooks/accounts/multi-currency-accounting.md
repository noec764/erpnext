...
<img class="screenshot" alt="Customer Accounting Currency"  	src="./assets/multi-currency/customer.png">
...
<img class="screenshot" alt="Sales Invoice Outstanding"  	src="./assets/multi-currency/sales-invoice.png">
...
<img class="screenshot" alt="Journal Entry Exchange Rate"  	src="./assets/multi-currency/journal-entry-multi-currency.png">
...
<img class="screenshot" alt="Journal Entry in multi currency"  	src="./assets/multi-currency/journal-entry-row.png">
...
<img class="screenshot" alt="General Ledger Report"  	src="./assets/multi-currency/general-ledger.png">

### Accounts Receivable / Payable

In Accounts Receivable / Payable report, system shows all the amounts in Party / Account Currency.

<img class="screenshot" alt="Accounts Receivable Report"  	src="./assets/multi-currency/accounts-receivable.png">
