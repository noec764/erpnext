...
<img alt="Adding Margin in Pricing Rule" class="screenshot"  src="../assets/margin-pricing-rule.png">
...
<img alt="Adding Margin in Pricing Rule" class="screenshot"  src="../assets/margin-item-price-list.png">
...
<img alt="Adding Margin in Quotation" class="screenshot"  src="../assets/margin-quotation-item.png">
