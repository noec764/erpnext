...
In Dooks, you can create a Drop Shipping by creating Purchase Order against Sales Order.
...
<img class="screenshot" alt="Setup Item Master" src="../assets/setup-drop-ship-on-item-master.png">
...
<img class="screenshot" alt="Setup Drop Shipping on Sales Order Item" src="../assets/setup-drop-ship-on-sales-order-item.png">

#### Create Purchase Order
After submitting a Sales Order, create Puchase Order.

<img class="screenshot" alt="Setup Drop Shipping on Sales Order Item" src="../assets/drop-ship-sales-order.png">
...
<img class="screenshot" alt="Purchase Order for Drop Shipping" src="../assets/drop-ship-purchase-order.png">
...
<img class="screenshot" alt="Close Sales Order" src="../assets/close-sales-order.png">
...
<img class="screenshot" alt="Drop Dhip Print Format" src="../assets/drop-ship-print-format.png">
