...
is used and some basic concepts in Dooks.
...
This represents the Company records for which Dooks is setup. With this same
...
“Supplier Mae” are accounts. Dooks creates accounts for Customers and
...
Credits of those entries is the same. In Dooks you can update Payments,
...
Dooks allows you to book transactions in multiple currencies. There is only
...
A request made by a system User, or automatically generated by Dooks based
...
from the Dooks website module. Blog is a short form of “Web Log”.
...
> Setup > Customize Dooks > Custom Field
...
Dooks is a modern tool that covers not only accounting but also all other
...
## Getting Started with Dooks

There are many ways to get started with Dooks.
...
### 2\. Start a Free Account at Dooks.com


Dooks.com is managed by the organization (Frappe) that publishes Dooks.
You can start with your own account by [signing up on the
website](https://dooks.com).

You can also decide to host your application at dooks.com by buying the
hosting plans. This way you support the organization that develops and
improves Dooks. You also get one-to-one functional (usage) support with the
hosting plans.

### 3\. Download a Virtual Machine

To avoid the trouble of installing an instance, Dooks is available as a
Virtual Image (a full loaded operating system with Dooks installed). You can
use this on **any** platform including Microsoft Windows.

[Click here to see instructions on how to use the Virtual
Image](https://dooks.com/download)

### 4\. Install Dooks on your Unix/Linux/Mac machine
...
### Test Phase
  ...
  * Read the Manual
  * Create a free account at [https://dooks.com](https://dooks.com) (the easiest way to experiment).
...
Once you are familiar with Dooks, start entering your live data!
  ...
  * You can also setup a new account at [https://dooks.com](https://dooks.com), and use the 30-day free trial. [Find out more ways of deploying Dooks](docs/user/manual/en/introduction/getting-started-with-dooks)
  ...
  * If you need help, [you can buy support](https://dooks.com/pricing) or [ask in the user forum](https://discuss.dooks.com).

## Flow Chart Of Transactions In Dooks

This diagram covers how Dooks tracks your company information across key
functions. This diagram does not cover all the features of Dooks.

![](/docs/assets/old_images/dooks/overview.png)


<img class="screenshot" alt="Workflow" src="./assets/overview.png">

_Note: Not all of the steps are mandatory. Dooks allows you to freely skip
...
- [https://github.com/frappe/dooks](https://github.com/frappe/dooks)
