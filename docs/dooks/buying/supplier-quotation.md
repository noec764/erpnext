...
![Supplier Quotation](./assets/buying_flow.png)
...
<img class="screenshot" alt="Supplier Quotation" src="./assets/supplier-quotation.png">
...
<img class="screenshot" alt="Supplier Quotation" src="./assets/add_taxes_to_doc.png">

Besides, in case of multiple items you can keep track of taxes on each by clicking "Show tax break-up"

<img class="screenshot" alt="Supplier Quotation" src="./assets/show_tax_breakup.png">
