...
<img alt="Supplier Item Code" class="screenshot" src="../assets/supplier-item-code.png">
...
<img alt="Supplier Item Code in transaction" class="screenshot" src="../assets/supplier-item-code-in-purchase-order.png">