...
<img alt="Item Purchase UoM" class="screenshot" src="../assets/editing-uom-in-po.gif">

#### Step 2: Update UoM Conversion Factors

In one Box, if you get 20 Nos. of Pen, UoM Conversion Factor would be 20.

<img alt="Item Conversion Factor" class="screenshot" src="../assets/po-conversion-factor.png">
...
<img alt="Purchase Qty in Default UoM" class="screenshot" src="../assets/po-qty-in-stock-uom.png">
...
<img alt="Print Format in Purchase UoM" class="screenshot" src="../assets/po-stock-uom-ledger.png">
...
<img alt="Purchase UoM master" class="screenshot" src="../assets/item-purchase-uom-conversion.png">
