...
<img alt="Item Purchase UoM" class="screenshot" src="../assets/for-supplier-2.png">
...
<img alt="Item Purchase UoM" class="screenshot" src="../assets/for-supplier-1.gif">

####Step 4: Get Items

Select Supplier name and click on `Get`.

<img alt="Item Purchase UoM" class="screenshot" src="../assets/for-supplier-3.png">
